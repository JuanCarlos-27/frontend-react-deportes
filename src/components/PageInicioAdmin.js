...
class PageInicioAdmin extends Component {
    ...
    peticionGetEventos = () => {
        axios.get('https://backend-nodejs-deportes-production.up.railway.app/api/eventos/').then(response => {
    ...
    peticionGetUsuarios= () => {
        axios.get('https://backend-nodejs-deportes-production.up.railway.app/api/usuarios/').then(response => {
